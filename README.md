...
### オプション  
ResNet/Swin Transformer/Vision Transformer の閾値を明示指定。  
(指定しない場合はデフォルトの閾値ResNet/Swin/ViT=0.7/0.075/0.975が使用される)
```
venv/bin/python3 EMSVfilter.py image_dir --thresholds 0.7 0.075 0.975 > result.txt
```
